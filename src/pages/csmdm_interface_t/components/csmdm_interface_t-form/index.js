...
class Csmdm_interface_tForm extends Component {
    constructor(props){
        super(props)
        this.state = {
            interface_id: '',
    ...
    search = (error,values) => {
        this.props.form.validateFields(async (err, values) => {
            ...
            await actions.csmdm_interface_t.loadList(values);
        });
    ...
    render(){
        ...
        return (
            <SearchPanel
                    className='csmdm_interface_t-form'
...
export default Form.createForm()(Csmdm_interface_tForm)